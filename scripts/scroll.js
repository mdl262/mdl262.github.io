// by akinuri @ https://github.com/akinuri/scroll
// some modifications by Max Li

function Scroll(delay, query = null) {
    ...
    if (query) {
        document.querySelectorAll(query)[0].addEventListener("scroll", this.handler);
    } else {
